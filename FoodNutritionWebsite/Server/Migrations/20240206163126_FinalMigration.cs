        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "fd1130b6-c65e-414c-b29e-1890645b457e", "admin@localhost.com", false, "Admin", null, "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEKGv3uupGhUB5jPi9Oz4Jo8K5el+i2WozVYzky0WsP9RUeFIxBqOfh+b2sCe5iTZ9Q==", null, false, "ee7bedad-4ca0-4be4-87f8-804cb6c1a2c2", false, "admin@localhost.com" },
                    { "a9ae8ce6-55cb-48f1-8e73-894563807efa", 0, "04299842-e9bd-417c-a08d-5b7b2e277286", "user@localhost.com", false, "User", null, "User", false, null, "USER@LOCALHOST.COM", "USER@LOCALHOST.COM", "AQAAAAIAAYagAAAAEKJVyIXCqrdULndSqwxypAEM4C9QOc5Vd5RbvVm+y/OXxWh5wl1gzWohiFYW72zejg==", null, false, "9b8d72ad-e99c-4d98-bd4e-19e904993e64", false, "user@localhost.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "seed-script", new DateTime(2024, 2, 7, 0, 31, 26, 447, DateTimeKind.Local).AddTicks(1245), null, "Male", null, null, "12/1/2001", "TestingAccount@blazor.com", "TestingAccount", "TestingAccount_password123", "9012 0791" },
                    { 2, "seed-script", new DateTime(2024, 2, 7, 0, 31, 26, 447, DateTimeKind.Local).AddTicks(1262), null, "Female", null, null, "12/1/2005", "TestAccount@blazor.com", "TestAccount@blazor.com", "TestAccount_password123", "9072 0791" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, new DateTime(2024, 2, 7, 0, 31, 26, 447, DateTimeKind.Local).AddTicks(2291), 2, null, null, null, 2.0, null, 1 },
                    { 2, null, null, new DateTime(2024, 2, 7, 0, 31, 26, 447, DateTimeKind.Local).AddTicks(2294), 3, null, null, null, 3.0, null, 2 }
                });
